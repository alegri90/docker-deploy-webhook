...
if (!process.env.TOKEN || !process.env.USERNAME || !process.env.PASSWORD) return console.error('Error: You must set a TOKEN, USERNAME and PASSWORD as environment variables.');
